...
public class RouteSecurityPolicyRegistry {
    ...
    private static final List<RouteAuthorizationPolicy> AUTHORIZATION_POLICIES = List.of(
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/media/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/v1/media"),
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/skills/*/*/versions/*"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/skills/*/*/versions/*/media"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/v1/skills/*/*/versions/*/media"),
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/skills/*/*/versions/*"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/skills/*/*/versions/*/media"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/web/skills/*/*/versions/*/media"),
    ...
    private static final List<ApiTokenPolicy> API_TOKEN_POLICIES = List.of(
            ...
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/v1/media/*"),
            ...
            ApiTokenPolicy.require(HttpMethod.POST, "/api/v1/media", "skill:publish"),
            ApiTokenPolicy.require(HttpMethod.POST, "/api/v1/skills/*/*/versions/*/media", "skill:publish"),
            ApiTokenPolicy.require(HttpMethod.POST, "/api/web/skills/*/*/versions/*/media", "skill:publish"),
