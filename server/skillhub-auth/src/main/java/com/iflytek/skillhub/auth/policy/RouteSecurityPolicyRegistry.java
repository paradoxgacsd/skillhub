...
public class RouteSecurityPolicyRegistry {
    ...
    private static final List<RouteAuthorizationPolicy> AUTHORIZATION_POLICIES = List.of(
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/promotion-slots/**"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.POST, "/api/v1/promotion-slots/campaigns/*/events/*"),
    ...
    private static final List<ApiTokenPolicy> API_TOKEN_POLICIES = List.of(
            ...
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/v1/namespaces/*"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/v1/promotion-slots/**"),
            ApiTokenPolicy.allow(HttpMethod.POST, "/api/v1/promotion-slots/campaigns/*/events/*"),
